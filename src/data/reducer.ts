...
type ReducerHash = {
  [ActionName.CREATE_SHELF_LABEL]: Reducer<State, ActionHash[ActionName.CREATE_SHELF_LABEL]>,
  ...
  [ActionName.DESTROY_SHELF_LABEL]: Reducer<State, ActionHash[ActionName.DESTROY_SHELF_LABEL]>,
...
const reducerHash: ReducerHash = {
  [ActionName.CREATE_SHELF_LABEL]: ensureExistMetaReducer(TableName.shelfLabels),
  ...
  [ActionName.DESTROY_SHELF_LABEL]: denyExistMetaReducer(TableName.shelfLabels),
